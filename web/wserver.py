...
rawowners = "<h1 style='text-align: center'>See my Channel <a href='https://telegram.me/gcloner'>@Telegram</a><br><br>By<br><br><a href='https://github.com/killerlearner'>Killerlearner</a></h1>"
...
<body>
    <!--© Designed and coded by @killerlearner-Telegram-->
    <header>
        <div class="brand">
        ...
        <div class="social">
            <a href="https://www.github.com/killerlearner"><i class="fab fa-github"></i></a>
            <a href="https://telegram.me/killerlearner"><i class="fab fa-telegram"></i></a>
        </div>
    </header>
    <!-- pin_entry -->
    <!-- files_list -->
